...
res_dict = {
    "linear_game_H3_A10_N0.5_T100000_N0.5": {
        ...
        "LSFTRL_3.593813663804628e-06_True_max(1.5log(x),5)_G0.001",
        "LSOMD_27.825594022071265_True_max(1.5log(x),5)_G0.001",
    ...
    "linear_game_H5_A5_N0.5_T100000_N0.5": {
        ...
        "BalancedOMD_0.7742636826811277",
        "LSFTRL_4.641588833612779e-07_True_max(1.5log(x),5)_G0.001",
        "AdaptiveFTRL_1291549.6650148837",
        "IXOMD_0.0016681005372000592",
        "LSOMD_0.03593813663804629_True_max(1.5log(x),5)_G0.001"
    }
}
...
plot_order = ["IXOMD", "BalancedOMD", "BalancedFTRL", "AdaptiveFTRL", "LSOMD", "LSFTRL"]

task_name_dict = {
    "linear_game_H3_A10_N0.5_T100000_N0.5": r"Linear Game ($A=10$, $H=3$)",
    "linear_game_H5_A5_N0.5_T100000_N0.5": r"Linear Game ($A=5$, $H=5$)",
}
